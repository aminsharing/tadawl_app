...
class SelectedNav0 extends StatelessWidget {
  const SelectedNav0({Key key, @required this.advFee}) : super(key: key);
  final AdvFeeProvider advFee;
    ...
    return Column(
      ...
      children: [
        ...
        if (advFee.selectedNav2 == 2)
          FeeCard(selectedNav: selectedNav2, price: '2500', type: 'العضوية المميزة', cardType: CardType.big,),
        if (advFee.selectedNav2 == 1)
          FeeCard(selectedNav: selectedNav1, price: '1900', type: 'العضوية الاحترافية', cardType: CardType.big,),
        if (advFee.selectedNav2 == 0)
          FeeCard(selectedNav: selectedNav0, price: '750', type: 'العضوية الأساسية', cardType: CardType.big,),
        Padding(
