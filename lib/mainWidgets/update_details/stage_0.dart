...
class Stage0 extends StatelessWidget {
  const Stage0(this._id_description ,{Key key, @required this.updateDetailsProvider}) : super(key: key);
  final String _id_description;
  final UpdateDetailsProvider updateDetailsProvider;

  @override
  Widget build(BuildContext context) {
    Provider.of<UpdateDetailsProvider>(context, listen: false).getAdsPageInfoUpdateDetails(context, _id_description);
