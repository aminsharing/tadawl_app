...
//
//
//   void getAdPage(BuildContext context, {int i}) {
//     var mutualPro = Provider.of<MutualProvider>(context, listen: false);
//     if(i == null){
//       mutualPro.getAdsPageList(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getImagesAdsPageList(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getUserAdsPageInfo(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getAdsVRInfo(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getBFAdsPageList(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getQFAdsPageList(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getViewsChartInfo(context, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.getNavigationAdsPageList(context);
//       mutualPro.getSimilarAdsList(context, _SelectedAdsModelMainPage.idCategory, _SelectedAdsModelMainPage.idDescription);
//       mutualPro.setIdDescription(_SelectedAdsModelMainPage.idDescription);
//     }else{
//       mutualPro.getAdsPageList(context, _MenuAds[i].idDescription);
//       mutualPro.getImagesAdsPageList(context, _MenuAds[i].idDescription);
//       mutualPro.getUserAdsPageInfo(context, _MenuAds[i].idDescription);
//       mutualPro.getAdsVRInfo(context, _MenuAds[i].idDescription);
//       mutualPro.getBFAdsPageList(context, _MenuAds[i].idDescription);
//       mutualPro.getQFAdsPageList(context, _MenuAds[i].idDescription);
//       mutualPro.getViewsChartInfo(context, _MenuAds[i].idDescription);
//       mutualPro.getNavigationAdsPageList(context);
//
//       mutualPro.getSimilarAdsList(context, _MenuAds[i].idCategory, _MenuAds[i].idDescription);
//       mutualPro.setIdDescription(_MenuAds[i].idDescription);
//     }
//
//   }
//
